...
export enum TipsMessage {
  ...
  viewSeedInfoOnMainChain = "To view SEED info, please transfer this SEED to your address on aelf dAppChain beforehand. Once it's on the SideChain, you can view its info on Forest.",
}
